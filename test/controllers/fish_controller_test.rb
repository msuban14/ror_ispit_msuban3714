...
class FishControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fish" do
    assert_difference('Fish.count') do
      post fish_index_url, params: { fish: { description: @fish.description, latin_name: @fish.latin_name, name: @fish.name } }
    end
  ...
  test "should update fish" do
    patch fish_url(@fish), params: { fish: { description: @fish.description, latin_name: @fish.latin_name, name: @fish.name } }
